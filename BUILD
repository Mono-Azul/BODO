...
Linux:
pyinstaller --onefile --add-data "static:static" --add-data "templates:templates" -n BODE webengine.py

Windows:
First rename webengine.py to webengine.pyw to get rid of the command window!
pyinstaller --onefile --add-data "static;static" --add-data "templates;templates" -n BODE -w webengine.pyw
